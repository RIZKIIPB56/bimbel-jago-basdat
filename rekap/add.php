...
<font color = #FFFAFA>
    <div class="box">
        <h1>Rekapitulasi Studi</h1>
            <h4>
                <small><font color = #FFFAFA>Hasil Bimbingan Belajar Online</font></small>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <form action="proses.php" method="post">
                        <div class="form-group">
                            <label for="kode_rekap">Kode Rekapitulasi </label>
			                <input type="text" name="kode_rekap" class="form-control"  />    
                        <div class="form-group">
                            <label for="idmurid">ID Murid</label>
                            <select name="idmurid" id="idmurid" class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nilai" id="nilai" class="form-control" rows="1" required>
                        </div>
